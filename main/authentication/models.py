...
class Profile(db.Model):
    ...
    profile_picture = db.Column(db.String(200), nullable=True, default="")
    date_of_birth = db.Column(db.String(200), nullable=True, default="")
    university = db.Column(db.String(100), nullable=True, default="")
    course = db.Column(db.String(100), nullable=True, default="")
